...
function Products() {
    ...
    const filteredProducts = products.filter(eachProduct => eachProduct.id >= 25 && eachProduct.id <= 55 && eachProduct.id != 39);
    ...
    return (
        <>
            ...
            <div id="flex-container">
                {products.length > 0 && filteredProducts.map((eachProduct, index) => {
                    return (
